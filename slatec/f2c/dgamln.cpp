...
double dgamln_(double const *z__, integer *ierr)
{
    /* Initialized data */

    static double const gln[100] = { 0.,0.,.693147180559945309,
	    ...
	    359.134205369575399 };
    static double const cf[22] = { .0833333333333333333,-.00277777777777777778,
	    ...
	    -21320333960919373.9 };
    static double const con = 1.83787706640934548;
