...
static double const c_b10 = .5;
static double const c_b11 = 0.;
	...
	nz, double *tol, double *elim, double *alim)
{
    ...
    static double const spi = 1.90985931710274403;
    static double const hpi = 1.57079632679489662;
    static double const fpi = 1.89769999331517738;
    static double const tth = .666666666666666666;
    static double const cc[8] = { .577215664901532861,-.0420026350340952355,
    ...
    static double const ctwor = 2.;
    static double const r1 = 2.;
    static double const dpi = 3.14159265358979324;
    static double const rthpi = 1.25331413731550025;
    ...
    integer nw;
    double p1i, p2i, s1i, s2i, p2m, p1r, p2r, s1r, s2r, cbi, cbr, cki = 0.,
	    caz, csi, ckr = 0., fhs, fks, rak, czi, dnu, csr, elm, zdi, bry[3],
...
/* ----------------------------------------------------------------------- */
    t1 = (double) (i1mach_(14) - 1);
    t1 = t1 * d1mach_(5) * 3.321928094;
    t1 = max(t1,12.);
    t1 = min(t1,60.);
    t2 = tth * t1 - 6.;
    if (*zr != 0.) {
