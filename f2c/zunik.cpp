 /* zunik.f -- translated by f2c (version 20100827).
...
int zunik_(double *zrr, double *zri, double const *fnu,
	 integer const *ikflg, integer const *ipmtr, double *tol, integer *init,
	...
	double *sumi, double *cwrkr, double *cwrki)
{
    ...
    static double const c__[120] = { 1.,-.208333333333333333,.125,
